...
slave_heal_ip = ['192.168.29.101', '192.168.29.102', '192.168.29.103','192.168.29.104','192.168.29.105','192.168.29.106','192.168.29.107','192.168.29.108','192.168.29.109','192.168.29.110','192.168.29.111', '192.168.29.112', '192.168.29.113', '192.168.29.114','192.168.29.115','192.168.29.116','192.168.29.117','192.168.29.118','192.168.29.119','192.168.29.120','192.168.29.121','192.168.29.122','192.168.29.123','192.168.29.124','192.168.29.125']
...
slave_odd_lost = ['192.168.29.103', '192.168.29.105', '192.168.29.107', '192.168.29.109',]
slave_even_lost = ['192.168.29.102', '192.168.29.104', '192.168.29.106', '192.168.29.108', '192.168.29.110']
...
def CHECK_network_connection_odd(slave_host_odd, wait_time=None):
    ...
    while True:
        ...
        if response==0: # Link is OK.
            ...
            if down_counter > 2:
		if slave_host_odd == '192.168.29.69':
...
def CHECK_network_connection_even(slave_host_even, wait_time=None):
    ...
    while True:
        ...
        if response==0: # Link is OK.
            ...
            print('{} - Connection to router is DOWN for {} times.'.format(time.ctime(), down_counter))
            if down_counter > 2:
		if slave_host_even == '192.168.29.69':
...
def vehicle_connection():
    ...
    try:
        #vehicle1 = connect('udpin:192.168.29.8:14551', baud=115200, heartbeat_timeout=heartbeat_timeout_data[0])
        vehicle1 = connect('udpin:192.168.29.69:14551', baud=115200, heartbeat_timeout=30)
    ...
    try:
        vehicle2 = connect('udpin:192.168.29.69:14552', baud=115200, heartbeat_timeout=3)
	...
	uavs_array.append('uav2')
        ...
        #time.sleep(0.5)
    try:
        vehicle3 = connect('udpin:192.168.29.69:14553', baud=115200, heartbeat_timeout=3)
    ...
    try:
        vehicle4 = connect('udpin:192.168.29.69:14554', baud=115200, heartbeat_timeout=3)
        ...
        #time.sleep(0.5)
    try:
        vehicle5 = connect('udpin:192.168.29.69:14555', baud=115200, heartbeat_timeout=3)
        ...
        #time.sleep(0.5)
    try:
        vehicle6 = connect('udpin:192.168.29.69:14556', baud=115200, heartbeat_timeout=3)
        ...
        #time.sleep(0.5)
    try:
        vehicle7 = connect('udpin:192.168.29.69:14557', baud=115200, heartbeat_timeout=3)
        ...
        #time.sleep(0.5)
    try:
        vehicle8 = connect('udpin:192.168.29.69:14558', baud=115200, heartbeat_timeout=3)
        ...
        #time.sleep(0.5)
    try:
        vehicle9 = connect('udpin:192.168.29.69:14559', baud=115200, heartbeat_timeout=30)
        ...
        #time.sleep(0.5)
    try:
        vehicle10 = connect('udpin:192.168.29.69:14560', baud=115200, heartbeat_timeout=30)
    ...
    try:
        vehicle11 = connect('udpin:192.168.29.69:14561', baud=115200, heartbeat_timeout = 0.5)
        ...
        #time.sleep(0.5)
    try:
        vehicle12 = connect('udpin:192.168.29.69:14562', baud=115200, heartbeat_timeout = 0.5)
    ...
    try:
        vehicle13 = connect('udpin:192.168.29.69:14563', baud=115200, heartbeat_timeout = 0.5)
        ...
        #time.sleep(0.5)
    try:
        vehicle14 = connect('udpin:192.168.29.69:14564', baud=115200, heartbeat_timeout = 0.5)
        ...
        #time.sleep(0.5)
    try:
        vehicle15 = connect('udpin:192.168.29.69:14565', baud=115200, heartbeat_timeout = 0.5)
    ...
    """
    try:
        vehicle16 = connect('udpin:192.168.29.69:14566', baud=115200, heartbeat_timeout = 0.5)
        ...
        #time.sleep(0.5)
    try:
        vehicle17 = connect('udpin:192.168.29.69:14567', baud=115200, heartbeat_timeout = 0.5)
        ...
        #time.sleep(0.5)
    try:
        vehicle18 = connect('udpin:192.168.29.69:14568', baud=115200, heartbeat_timeout = 0.5)
        ...
        #time.sleep(0.5)
    try:
        vehicle19 = connect('udpin:192.168.29.69:14569', baud=115200, heartbeat_timeout = 0.5)
    ...
    try:
        vehicle20 = connect('udpin:192.168.29.69:14570', baud=115200, heartbeat_timeout = 0.5)
    ...
    try:
        vehicle21 = connect('udpin:192.168.29.69:14571', baud=115200, heartbeat_timeout = 0.5)
        ...
        #time.sleep(0.5)
    try:
        vehicle22 = connect('udpin:192.168.29.69:14572', baud=115200, heartbeat_timeout = 0.5)
        ...
        #time.sleep(0.5)
    try:
        vehicle23 = connect('udpin:192.168.29.69:14573', baud=115200, heartbeat_timeout = 0.5)
        ...
        #time.sleep(0.5)
    try:
        vehicle24 = connect('udpin:192.168.29.69:14574', baud=115200, heartbeat_timeout = 0.5)
    ...
    try:
        vehicle25 = connect('udpin:192.168.29.69:14575', baud=115200, heartbeat_timeout = 0.5)
...
def update_plot():	
	...
	elapsed_time = 0
	file_sock.sendto(str(filename).encode(),file_server_address)
	time.sleep(0.5)
	...
	def update_plot1(canvas):
		...
		while True:
			...
			try:
				...
				if (data==b"start") or (data==b"aggregate") or (data==b"return") or (data==b"same altitude") or (data==b"different altitude") or (data==b"resume") or (data==b"stop") or (data==b"home") or(data==b"search") or (data==b"circle formation") or (data.startswith(b"Drone"))or (data.startswith(b"vehicle")) or (data.startswith(b"master_num"))or (data.startswith(b"pos_array")):
				...
				if data.startswith(b"search,"):
					...
					if(count==0):
						print("&&&&&&&&")
						filepath=fileloc+filename+'_search'+".yaml"
						size,obs=update_load_yaml(filepath)
					"""
				...
				#if len(uav_positions['uav_1']) % 5 == 0:
                # Plot at 5-second intervals
				...
				if home_pos_flag:
					...
					marked_points_y = [point[1] for point in home_pos]
				    	for i, (x, y) in enumerate(home_pos):
				    		#print("x,y",x,y)
						#ax.scatter(x, y, marker="${}$".format(i), color="red", s=100, label="Home Pos {}".format(i))
				...
				#canvas.draw_idle()
			#update_plot1(canvas)
			#root.after(100, update_plot1(canvas))
			#print("Updateeeeeeeeeeeeeeeeeeeeee")
			root.update()	
	update_plot1(canvas)
...
def clear_home_pos_markers():
    ...
    update_plot()  # Re-plot the obstacles or any other elements you want to keep
...
def share_data_func():
	...
	"""
	#a="share_data"+","+str(goal_table)
	#print("goal_table",str(a),a)
...
def Reconnect():
    ...
    connection_string = "udpin:192.168.29.69:"+str(Reconnect_port)
...
def master():
    ...
    udp_socket = socket.socket(socket.AF_INET, socket.SOCK_DGRAM)
    server_address1 = (master_ip, 12008)
    print("server_address1",server_address1)
	#server_address2=('192.168.29.151', 12008)

    socket1 = socket.socket(socket.AF_INET, socket.SOCK_DGRAM)
    server_address11 = (master_ip, 12002)
	#server_address12 = ('192.168.29.151', 12002)

    file_sock = socket.socket(socket.AF_INET, socket.SOCK_DGRAM)
    file_server_address = (master_ip, 12003)
    
    print("master_ip",file_server_address,master_ip)
    '''
...
if __name__ == "__main__" : 
   ...
   # frame_1 = Frame(height = 920, width = 1670, bd = 3, relief = 'groove').place(x = 7, y = 5)
    ...
    frame_2 = Frame(height = 180, width = 1250+65+50+540, bd = 3, relief = 'groove').place(x = 7, y = 930)
  ...
  #  frame_5 = Frame(height = 120, width = 300-70, bd = 3, relief = 'groove').place(x = 1682, y = 930)
    ...
    Button(text = "Return", command = return_socket, width =6, font=("Times New Roman", 13)).place(x = 860+70+10, y = 985)
   # Button(text = "Resume", command = resume_socket, width = 6, font=("Times New Roman", 13)).place(x = 860+70+15+10, y = 1020)
    ...
    Button(text = "Stop", command = stop_socket, width = 6, font=("Times New Roman", 13)).place(x = 960+70, y = 985)
    ...
    Button(text = "Cancel_Mission", command = strike_stop, width = 10, font=("Times New Roman", 13),fg='red').place(x = 280, y = 850)
...
# Create a Label widget to display the area covered
    area_covered_label = tk.Label(root, textvariable=area_covered_var, font=("Times New Roman", 13)).place(x = 1120+30, y =1030)
    ...
    Button(text = "Specific_Bot_Goal", command = specific_bot_goal_socket, width = 20, font=("Times New Roman", 13)).place(x = 1600+20, y= 880+60)
    Button(text = "Goal", command = goal_socket, width = 5, font=("Times New Roman", 13)).place(x = 1500+20, y= 880+60)
    Button(text = "Move Bot", command = move_bot_socket, width = 7, font=("Times New Roman", 13)).place(x = 1400+20, y= 880+60)
    goal_entry= Entry()
    goal_entry.place(x = 1500+20,  y= 900+80,width = 100)
    move_bot_entry= Entry()
    move_bot_entry.place(x = 1400+20,  y= 900+80,width = 100)
    
    specific_bot_goal_entry= Entry()
    specific_bot_goal_entry.place(x = 1600+20+35, y= 900+80)
    ...
    Button(text = "Home_Lock", command = home_lock, width = 7, font=("Times New Roman", 13)).place(x = 820, y = 1025,width=100,height=30)

    Button(text = "PLOT", command = update_plot, width = 7, font=("Times New Roman", 13)).place(x = 1000+70+50+10, y = 1000-10-2)
    Button(text = "Add link", command = mavlink_add, width = 7, font=("Times New Roman", 13)).place(x = 610, y = 1025)
    Button(text = "Remove link", command = mavlink_remove, width = 8, font=("Times New Roman", 13)).place(x = 710, y = 1025)
    ...
    home_checkbox.place(x = 1020, y = 1030)
    ...
    goal_checkbox.place(x = 920, y = 1030)
   ...
   #home_pos_checkbox = tk.Checkbutton(root,text="Home Position",variable=show_home_pos,command= plot_home_pos(home_pos) )
    ...
    '''
    Button(text = "MASTER =", command = master, width = 7, font=("Times New Roman", 10)).place(x = 1120+70+50, y = 1000-10-2)
    masterset_entry = Entry()
    masterset_entry.place(x = 1230+70+30, y = 1000-10, width = 30, height = 25)	
