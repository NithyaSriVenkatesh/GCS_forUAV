...
def vehicle_connection():
    ...
    try:
        vehicle4 = connect('udpin:192.168.29.69:14554', baud=115200, heartbeat_timeout=30)
	...
	def update_plot1(canvas):
		...
		while True:
			...
			try:
				...
				if (data==b"start") or (data==b"aggregate") or (data==b"return") or (data==b"same altitude") or (data==b"different altitude") or (data==b"disperse") or (data==b"stop")  or(data==b"search") or (data==b"circle formation") or (data.startswith(b"Drone"))or (data.startswith(b"vehicle")) or (data.startswith(b"master_num"))or (data.startswith(b"pos_array")) or (data.startswith(b"home")) or (data=="rtl") or (data==b"goal") or (data==b"specific_bot_goal") or (data==b"CSV Cleared") or (data==b"Strike Cancelled"):
